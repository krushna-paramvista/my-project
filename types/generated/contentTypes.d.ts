...
export interface ApiCandidateProfileCandidateProfile
  ...
  attributes: {
    Source_name: Attribute.String & Attribute.Required & Attribute.Private;
    Add_source_type: Attribute.Enumeration<
      ['Carrer Page', 'Internal Referal', 'Vendor', 'Requirement Team']
    >;
    ...
    Mobile_Number: Attribute.BigInteger & Attribute.Required;
    Current_Location: Attribute.String;
    Experience: Attribute.String;
    Upload_Resume: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiJobOpeningJobOpening extends Schema.CollectionType {
  ...
  attributes: {
    Job_Description: Attribute.Blocks & Attribute.Required;
    ...
    Location: Attribute.Enumeration<['Pune', 'Mumbai', 'Banglore', 'Delhi']> &
      Attribute.Required &
      Attribute.DefaultTo<'Pune'>;
    Job_Type: Attribute.Enumeration<
      ['Full Time', 'Remote', 'Internships', 'Hybrid']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Full Time'>;
    Minimum_Experience: Attribute.Enumeration<
      ['Exp 0-1 year', 'Exp 1-2 year', 'Exp 3-5 year']
    > &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    color: Attribute.Enumeration<['Red', 'Black', 'Orange', 'Blue ']> &
      Attribute.Required;
    price: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<0>;
    AvailableQuantity: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRestaurantRestaurant extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true> &
      Attribute.Required;
    OpeningHourse: Attribute.Component<'component.component', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
